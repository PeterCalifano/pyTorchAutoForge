echo "Hello! Installation as submodule begins. This is going to install pytorch-autoforge with all the dependencies in a virtual env and build its documentation."
echo -e "Starting in 1 second...\n\n"
sleep 1
sudo apt install python3.11 python3.11-venv # Install python3-venv
cd ../../ # Go to the root directory (assuming pytorch-autoforge is in root/submodules/)
...
cd submodules/pytorch_autoforge
