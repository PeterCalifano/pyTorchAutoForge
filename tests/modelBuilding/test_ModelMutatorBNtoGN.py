...
# TODO (PC) move class to src folder, this was an experimental script
...
def test_simple_model_mutation():
    ...
    mutator = ModelMutatorBNtoGN(model, numOfGroups=8)
    mutated_model = mutator.MutateBNtoGN()
...
def test_invalid_group_division():
    ...
    mutator = ModelMutatorBNtoGN(model, numOfGroups=32)
    mutated_model = mutator.MutateBNtoGN()
